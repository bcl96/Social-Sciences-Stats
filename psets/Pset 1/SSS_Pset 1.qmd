...
**ANSWER KEY:**
The output shows "/Users/bellelee/Documents/SSS, Fall 2024/problem_sets/problemset1" since that is the working directory I'm currently in. The getwd() code asks r studio to get or show the working directory. The output for list.files() shows "lee_belle_ps1.qmd" "problemset1.Rproj" since those are the two files in working directory.
...
**ANSWER KEY:**
The output of 246 and 22 means that our data frame netflix_data, contains 246 observations of 22 rows, variables, or number of items. 
...
**ANSWER KEY:**
The Walking Dead with 945,125 votes.
...
- Use this naming convention "lastname_firstname_ps#" for your .Rmd and pdf files (e.g. lee_belle_ps1.qmd & lee_belle_ps1.pdf)  
