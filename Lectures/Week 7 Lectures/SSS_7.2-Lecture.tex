...
Week 7: Learning goal - Demonstrate estimation and prediction of
bivariate regression analysis in R
...
\textbf{General things we do in regression analysis}
...
\item
  ...
  \tightlist
  \item
    How do we choose estimates of \(\beta_0\) and \(\beta_1\) using
    sample data?
  \end{itemize}
\end{enumerate}
...
Step 1 of regression is to estimate parameters of the population linear
regression model
...
\textbf{Goal of estimation: use sample data to estimate population
parameters}:

\begin{itemize}
\tightlist
\item
  Previous lecture: we used sample data on variable \(Y\) to estimate
  ...
  \end{itemize}
\item
  This lecture: use sample data to estimate the population intercept,
  \(\beta_0\), and the population regression coefficient, \(\beta_1\)
