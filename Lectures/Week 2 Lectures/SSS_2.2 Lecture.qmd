...
We will use public-use data from the [_National Center for Education Statistics (NCES) Educational Longitudinal Survey (ELS)_](https://nces.ed.gov/surveys/els2002/index.asp) of 2002:
...
- Example: The [Hue-Chroma-Luminance (HCL) color scheme](https://hclwizard.org/). 
